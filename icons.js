...
website:'<svg viewBox="0 0 64 64" aria-hidden="true"><rect x="9" y="12" width="46" height="40" rx="8" fill="rgba(255,255,255,.14)" stroke="#fff" stroke-width="3.5"/><path d="M9 22h46" stroke="#fff" stroke-width="3.5"/><circle cx="16" cy="17" r="2" fill="#fff"/><circle cx="22" cy="17" r="2" fill="#fff" opacity=".8"/><circle cx="28" cy="17" r="2" fill="#fff" opacity=".6"/><circle cx="32" cy="37" r="10" fill="none" stroke="#fff" stroke-width="3"/><path d="M22 37h20M32 27c3 3 4.5 6.3 4.5 10S35 44 32 47M32 27c-3 3-4.5 6.3-4.5 10S29 44 32 47" fill="none" stroke="#fff" stroke-width="2.6" stroke-linecap="round"/></svg>',
